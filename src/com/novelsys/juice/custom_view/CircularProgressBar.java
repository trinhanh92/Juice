package com.novelsys.juice.custom_view;

import com.novelsys.juice.R;
import com.novelsys.juice.R.color;
import com.novelsys.juice.R.styleable;
...
public class CircularProgressBar extends ProgressBar {
	...
	public void init(AttributeSet attrs, int style) {
		...
		mProgressColorPaint.setStrokeWidth(STROKE_WIDTH);

		mBackgroundColorPaint.setAntiAlias(true);
		mBackgroundColorPaint.setStyle(Paint.Style.STROKE);
		mBackgroundColorPaint.setStrokeWidth(STROKE_WIDTH);

		mTitlePaint.setTextSize(70);
		mTitlePaint.setStyle(Style.FILL);
		mTitlePaint.setAntiAlias(true);
		mTitlePaint
				.setTypeface(Typeface.create("Roboto-Thin", Typeface.BOLD));
